...
<body class="antialiased">
    ...
    <div class="container">
        @if (Session::get('trajetsRecherche'))
            @if (count(Session::get('trajetsRecherche')) > 0)
                ...
                <table class="table table-dark">
                    ...
                    <tbody>
                        @foreach (Session::get('trajetsRecherche') as $trajet)
                            <tr>
                                ...
                                @if (count($trajet->correspondances) > 0)
                                    <td>non(<a style="color: #718096;"
                                            href="{{ route('trajets.show', $trajet->id) }}">Voir toutes les
                                            correspondances</a>)</td>
                                @else
                                    <td>Oui</td>
                                @endif
                            </tr>
